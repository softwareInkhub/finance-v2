...
export default function BanksSidebar({ onSuperBankClick, onBankClick, onAccountClick, hideSearch, showOnlyMenu }: BanksSidebarProps) {
    ...
    return (
      <nav className="flex-1">
        <ul className="space-y-2 text-gray-700 text-sm">
          <li>
            <button
              className={`flex items-center gap-2 px-2 py-2 rounded hover:bg-blue-50 w-full text-left`}
          ...
          <li>
            ...
            <ul>
              {banks.map(bank => (
                <li key={bank.id}>
                  <button
                    className={`flex items-center w-full gap-2 px-2 py-2 rounded hover:bg-blue-50 transition`}
                    onClick={() => {
