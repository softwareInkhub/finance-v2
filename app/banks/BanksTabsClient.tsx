  ...
  return (
    <div>
      <div className="flex items-center gap-2 mb-2 sm:mb-3">
        ...
        <button
          onClick={handleSuperBankClick}
          className="ml-2 px-3 py-2 rounded-t-lg bg-gradient-to-r from-blue-500 to-purple-500 text-white font-bold shadow-sm hover:scale-105 transition"
          title="Super Bank"
        >
          Super Bank
        </button>
